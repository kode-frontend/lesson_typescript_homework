...
export const Home = () => {
  ...
  const [currentDepartment, setCurrentDepartment] = React.useState('all')
  ...
  const onItemClickHandler = (id) => navigate(`/contact/${id}`)
  ...
  return (
    <Container>
      ...
      <DepartmentTabs setCurrentDepartment={setCurrentDepartment} currentDepartment={currentDepartment} />
